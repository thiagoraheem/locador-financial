...
class LancamentoBase(BaseModel):
    ...
    idConta: Optional[int] = Field(None, description="Código da conta bancária")
...
class LancamentoUpdate(BaseModel):
    ...
    IndMov: Optional[Literal['E', 'S']] = Field(None, description="Indicador de movimento: E=Entrada, S=Saída")
    NumDocto: Optional[str] = Field(None, max_length=50, description="Número do documento")
...
class LancamentoFilter(BaseModel):
    ...
    id_conta: Optional[int] = Field(None, description="Filtrar por conta bancária")
