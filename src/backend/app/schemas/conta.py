...
class ContaBase(BaseModel):
    ...
    DesConta: str = Field(..., max_length=50, description="Nome/descrição da conta")
...
class ContaUpdate(BaseModel):
    ...
    OperacaoConta: Optional[str] = Field(None, max_length=15, description="Operação da conta")
    Convenio: Optional[str] = Field(None, max_length=10, description="Convênio")
    DesConta: Optional[str] = Field(None, max_length=50, description="Nome/descrição da conta")
